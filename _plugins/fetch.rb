...
HEY_WORLD_FEED_URL = URI("https://blog.nil.foundation/feed/by_tag/mina.xml")
...
class Post
  ...
  def filename
    ...
    POSTS_DIR.join("#{basename}.markdown")
  end
end
...
FileUtils.rm_rf(POSTS_DIR.join("*blog*"))
